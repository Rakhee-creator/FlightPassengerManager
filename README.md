...
•	Adding passengers and seat assignments
•	Printing a passenger manifest
•	Searching for passengers by name
...
•	main() → Entry point
•	ArrayList<String> → Stores passengers and seat numbers
•	Loops and conditions → Handle traversal, search, update, and cancellation

🌈 Future Enhancements
•	Create a Passenger class for cleaner object-oriented design
•	Add input via Scanner for dynamic passenger entry
•	Integrate sorting algorithms (bubble, selection, insertion) for seat order
•	Extend to 2D Arrays for multi-flight management
